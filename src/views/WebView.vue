...
const data: WebProject[] = [
  {
    ...
    imageSrc: assetUrl('portfolio.png'),
  ...
  },
  {
    ...
    githubUrl: null,
    description: 'Portfolio made with VueJS.',
    imageSrc: assetUrl('old-portfolio.png'),
  ...
  },
  {
    ...
    imageSrc: assetUrl('nebulift.png'),
    status: StatusType.DONE,
  ...
  },
  {
    ...
    imageSrc: assetUrl('mcskinapi.png'),
    status: StatusType.DONE,
  ...
  },
  {
    ...
    imageSrc: assetUrl('tictactoe.png'),
    status: StatusType.DONE,
